<template>
  <header class="z-30 w-full bg-white px-2 sm:px-4 py-4">
	<div class="container mx-auto flex justify-between items-center">
	  <a href="/" title="Payimize Home Page" class="flex items-center">
		<svg class="h-6 w-auto" width="86" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"
			 viewBox="0 0 335 93">
		  <path
		...
		<span class="sr-only">Payimize</span>
	  </a>
...
<!--        </div>-->
		...
		<div class="inline-flex md:hidden" x-data="{ open: false }">
		  ...
		  <div class="flex flex-col space-y-3 absolute m-2 top-0 left-0 right-0 rounded bg-white z-50 p-2 pb-4 shadow"
			...
			<a href="#" class="btn btn-link w-full">Sign in</a>
		  </div>
		</div>
	  </div>
	</div>
